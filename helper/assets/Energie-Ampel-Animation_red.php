<svg xmlns="http://www.w3.org/2000/svg" width="184.35mm" height="121.59mm" viewBox="0 0 522.57 344.66">
    ...
    <text class="text" x="20" y="43" ><?php _e('Wenig Strom im Netz','quartiersplaattform'); ?></text>
    <text class="text" x="10" y="210" ><?php _e('Erneuerbare Energien','quartiersplaattform'); ?></text>
    <text class="text" x="213" y="332" ><?php _e('Fossile Energieträger','quartiersplaattform'); ?></text>
    <text class="text" x="450" y="215" ><?php _e('Quartier','quartiersplaattform'); ?></text>
    <text class="text" x="216" y="15" ><?php _e('Stromampel auf rot','quartiersplaattform'); ?></text>
    <text class="text" x="410" y="45" ><?php _e('Viel Verbrauch','quartiersplaattform'); ?></text>
